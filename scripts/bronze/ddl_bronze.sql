...
/*Extra info: In other SQL Applications, we only wrote "Create or Replace" clause in case the table already existed.
			  But in SQL Server we need to create a T-SQL logic in order to make any changes to the metadata of the table if it already existed.
			  The syntax of this logic is 
			  IF OBJECT_ID ('TABLE_NAME', 'OBJECT_TYPE') IS NOT NULL
			  where 'U' stands for the user defined tables and tells the object type
*/
