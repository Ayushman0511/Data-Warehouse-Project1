...
BEGIN
	...
	BEGIN TRY
		...
		PRINT '>> Truncating Tavle: silver.crm_cust_info';
		...
		SET @start_time = GETDATE();
		PRINT '>> Truncating Tavle: silver.crm_prd_info';
		...
		SET @start_time = GETDATE();
		PRINT '>> Truncating Tavle: silver.crm_sales_details';
		...
		SET @start_time = GETDATE();
		PRINT '>> Truncating Tavle: silver.erp_cust_az12';
		...
		SET @start_time = GETDATE();
		PRINT '>> Truncating Tavle: silver.erp_loc_a101';
		...
		SET @start_time = GETDATE();
		PRINT '>> Truncating Tavle: silver.erp_px_cat_g1v2';
